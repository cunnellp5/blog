...
categories: tech
---
First blog post, first time using Jekyll. I like it.
...
Now that blogging is solved and I can write posts in .md, and focus on media. For images, I plan to run them through Squoosh for optimization, push them to a dedicated GitHub storage repository, and serve them via jsDelivr CDN. Why? Because I dont want to pay for anything or rely on 'big-media-optimization' companies, and there is a sufficient storage limit in GitHub.